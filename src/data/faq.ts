...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Sim. Visitantes são bem-vindos para assistir e rezar. A Santa Comunhão é reservada aos fiéis ortodoxos preparados.",
  ...
  },
  {
    ...
    answer:
      "É o calendário patrístico usado por este portal e por igrejas velho-calendaristas. Organiza festas, jejuns e memórias dos Santos segundo a tradição recebida.",
    href: "/calendario",
  },
  {
  ...
  },
  {
    ...
    answer:
      "A Igreja Ortodoxa é una na fé, com várias igrejas locais (grega, russa, antioquena, etc.). Este portal apresenta a tradição grega G.O.C., velho-calendarista, no Brasil.",
    href: "/igreja",
  },
  {
    question: "O que significa G.O.C.?",
    answer:
      "G.O.C. refere-se aos Genuine Orthodox Christians, os Cristãos Ortodoxos Genuínos, na linha do velho calendário. A referência canônica deste projeto é o Santo Sínodo de Eugenio de Atenas.",
    href: "/santo-sinodo",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Em muitas comunidades, sim, como sinal de recato. Leve um lenço na primeira visita. O essencial é o respeito ao templo; pergunte localmente se tiver dúvida.",
    href: "/primeira-visita",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Há uma página de pedidos de oração. As intenções passam por moderação antes de qualquer publicação.",
    href: "/pedido-de-oracao",
  },
  {
    question: "Por onde começo a catequese?",
    answer:
